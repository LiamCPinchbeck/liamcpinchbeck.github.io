...
[Matern kernel](https://scikit-learn.org/stable/modules/generated/sklearn.gaussian_process.kernels.Matern.html) and you can combine them to model different behaviours! You can play around with different
kernel [here](https://www.infinitecuriosity.org/vizgp/), it's a Gaussian Process interactive website that you can just view as something that will plot the forms of equations/relationships between coordinates that the kernels imply.
