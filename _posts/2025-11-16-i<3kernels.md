...
<div style="text-align: center;">
  <img 
      src="/files/BlogPostData/2025-i-<3-kernels/Ridge_Figures/PCA_example_data.png" 
      alt="PCA_example_data.png" 
      title="PCA_example_data.png" 
      style="width: 99%; height: auto; border-radius: 0px;">
</div>
...
<div style="text-align: center;">
  <img 
      src="/files/BlogPostData/2025-i-<3-kernels/PCA_Figures/centralised_data.png" 
...
- Maximal variance direction is maximised by the above lambda_1 eigen vector
- Got to use a given number of eigenvectors
    - 2 or 3, easy to visualise
    - Scree plot
        - proportion of explained variance
- Principle component regression
- Caveats
    - If $$n>>d$$ then bueno
    - If $$d>>n$$  then no bueno? $$\rightarrow$$ Sparse PCA
