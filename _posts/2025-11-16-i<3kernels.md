...
To keep the code even simpler again we will use [scikit-learn implementation](https://scikit-learn.org/stable/modules/gaussian_process.html) of gaussian processes, but there are a few other packages out there. Some of which [Shun Cheung goes through in there blog post on GPs](https://shunycheung.github.io/posts/2025/11/introduction_to_gaussian_processes/#:~:text=Code%20packages%20and%20examples).
