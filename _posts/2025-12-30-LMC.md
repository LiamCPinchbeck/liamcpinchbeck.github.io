...
2. A sneak peak: A purely intuitive idea of our goal
    - The "Blind Hiker" and "feeling" the slope
    - Particles in a Fluid/Drift and Diffusion
...
More formally, LMC introduces a drift into the proposal distribution or gradient flow using the gradient of the target probability density but otherwise uses the same accept-reject as the typical MHMCMC algorithm.

Below is a GIF showing how RWM and LMC converge on a target (same step size).

<div style="text-align: center;">
  <img 
      src="/files/BlogPostData/2025-12-LMC/rwm_path.gif" 
      style="width: 49%; height: auto; border-radius: 0px;">
  <img 
      src="/files/BlogPostData/2025-12-LMC/lmc_path.gif" 
      style="width: 49%; height: auto; border-radius: 0px;" >
  <img 
      src="/files/BlogPostData/2025-12-LMC/rwm_density.gif" 
      style="width: 49%; height: auto; border-radius: 0px;">
  <img 
      src="/files/BlogPostData/2025-12-LMC/lmc_density.gif" 
      style="width: 49%; height: auto; border-radius: 0px;" >
</div>
