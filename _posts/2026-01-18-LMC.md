...
i.e. You can view HMC (updates at least) as the boring SDE case of underdamped LMC where the noise is has 0 standard deviation / doesn't exist.
...
Invariant here meaning that once the system reaches that distribution, it stays there. i.e. a steady state. If we have a collection of particles distributed according to our target density $$p(z \vert S)$$, and apply the dynamics described by your SDE (the drift and the diffusion), the overall shape of that distribution doesn't change over time. And for the ergodicity of these process some sort of jump process has to be added, like the momentum resampling in HMC.
...
The targets I'll investigate are a standard 1D normal distribution, standard 2D normal (as done above), a highly correlated 2D normal and a 2D [student-t distribution](https://en.wikipedia.org/wiki/Student%27s_t-distribution) with unit scale matrix as well as the Banana, Neal's funnel and Funana distributions as discussed in ["Disentangling impact of capacity, objective, batchsize, estimators, and step-size on flow VI"](https://arxiv.org/abs/2412.08824)[^defn].

[^defn]: To be clear they didn't introduce any of them besides the Funana I believe, but I refer to it for definition.
...
>
$$z_i$$ $$\sim$$ $$\mathcal{N}(0, \exp(z_1))$$ $$\text{for} \; i=2, ..., d$$

For Neal's funnel we'll look at $$d=\{2, 10\}$$ but just look at the slices between $$z_1$$ and $$z_2$$. Some examples of what this look using some corner plots is shown below. Size of plot = dimensionality.

<div style="text-align: center;">
  <img 
      src="/files/BlogPostData/2026-01-LMC/Experiment_Dists/Neals_Dim2.png" 
      alt="Neals_Dim2.png"
      title="Neals_Dim2.png"
      style="width: 48%; height: auto; border-radius: 0px;">
  <img 
      src="/files/BlogPostData/2026-01-LMC/Experiment_Dists/Neals_Dim3.png" 
      alt="Neals_Dim3.png"
      title="Neals_Dim3.png"
      style="width: 48%; height: auto; border-radius: 0px;">
  <img 
      src="/files/BlogPostData/2026-01-LMC/Experiment_Dists/Neals_Dim4.png" 
      alt="Neals_Dim4.png"
      title="Neals_Dim4.png"
      style="width: 66%; height: auto; border-radius: 0px;">
</div>
<br>

>
#### Funana (slightly modified)
$$z_1$$ $$\sim$$ $$\mathcal{N}(0, 3^2)$$ 
>
$$z_2$$ $$\sim$$ $$\mathcal{N}(0, 10^2)$$ 
>
$$z_i$$ $$\sim$$ $$\mathcal{N}(0.03(z_2^2 - 100), \exp(z_1))$$ $$\text{for} \;\; i=3, ..., d$$


(original paper has some typos, the mean should be using $$z_2$$ to reproduce their Figure 2 and the below). Similar to the Neal's funnel we'll just look at $$d=\{2, 10\}$$. Some examples of what this look using some corner plots is shown below. Size of plot = dimensionality.


<div style="text-align: center;">
  <img 
      src="/files/BlogPostData/2026-01-LMC/Experiment_Dists/Funana_Dim3.png" 
      alt="Funana3.png"
      title="Funana3.png"
      style="width: 48%; height: auto; border-radius: 0px;">
  <img 
      src="/files/BlogPostData/2026-01-LMC/Experiment_Dists/Funana_Dim4.png" 
      alt="Funana_Dim4.png"
      title="Funana_Dim4.png"
      style="width: 48%; height: auto; border-radius: 0px;">
  <img 
      src="/files/BlogPostData/2026-01-LMC/Experiment_Dists/Funana_Dim5.png" 
      alt="Funana_Dim5.png"
      title="Funana_Dim5.png"
      style="width: 66%; height: auto; border-radius: 0px;">
</div>
<br>
...
## Overdamped Langevin Monte Carlo 
...
<div style="text-align: center;">
  ...
  <img 
      ...
      style="width: 88%; height: auto; border-radius: 0px;">
  <img 
      src="/files/BlogPostData/2026-01-LMC/Experiment_GIFs/NUTS/nuts_funnel.gif" 
      alt="Experiment_GIFs/NUTS/nuts_funnel.gif"
      title="Experiment_GIFs/NUTS/nuts_funnel.gif"
      style="width: 88%; height: auto; border-radius: 0px;">
</div>
<br>
...
Never heard of this one before the paper either.
