...
In this post I'm going to try and introduce Hamiltonian and Langevin Monte Carlo, and there stochastic gradient counterparts (among a couple other things). This post will involve a little stochastic differential calculus and some results from [A Complete Recipe for Stochastic Gradient MCMC - Ma et al. (2015)](https://arxiv.org/abs/1506.04696). (PARTLY UNDER CONSTRUCTION)
